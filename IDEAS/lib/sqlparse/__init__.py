...
# Setup namespace
from IDEAS.lib.sqlparse import engine
from IDEAS.lib.sqlparse import filters
from IDEAS.lib.sqlparse import formatter

# Deprecated in 0.1.5. Will be removed in 0.2.0
from IDEAS.lib.sqlparse.exceptions import SQLParseError
...
from IDEAS.lib.sqlparse.engine.filter import StatementFilter
